...
- 双仓库职责：GitHub 开发主仓库保留 commit、PR、GitHub PR/Actions 与 Pages；NJU GitLab 课程镜像已创建为 Private 并同步 `main@5fd86fa`。Pipeline #312781 的 `unit-test` 已通过、`docker-build` 失败，Kaniko daemonless 修复验证中；检查前改为 Public。
