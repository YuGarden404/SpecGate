...
当前证据口径：审查起点为 PR #20 合并后的 `main@c39d101`；该起点完整回归为 `Ran 908 tests in 210.559s`、`OK (skipped=27)`。当前最终交付合规 worktree 回归为 `Ran 919 tests in 402.898s`、`OK (skipped=27)`，退出码 0。
