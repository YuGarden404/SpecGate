...
7. 最后展示发布链并区分部署边界：PR #32 合并后的 `main@e3ec022` 已由 [CI #77](https://github.com/YuGarden404/SpecGate/actions/runs/30728989649)、[Pages #43](https://github.com/YuGarden404/SpecGate/actions/runs/30728989651) 和 [GHCR #4](https://github.com/YuGarden404/SpecGate/actions/runs/30729409707) 验证；[v0.3.0](https://github.com/YuGarden404/SpecGate/releases/tag/v0.3.0) 已发布，`ghcr.io/yugarden404/specgate:0.3.0` 已完成匿名拉取验证，digest 为 `sha256:baa5c61bd791f2b5e266e98fbd17affb1e9e6fd6dab6e829279a05d934f021e0`，OCI revision 为 `e3ec02236f6e65ccce2c49ab444ba0676db5a7ed`。历史 `v0.2.0` 继续绑定 PR #30、`main@f95e08c`、[Release](https://github.com/YuGarden404/SpecGate/releases/tag/v0.2.0)、镜像 `ghcr.io/yugarden404/specgate:0.2.0`、RepoDigest `sha256:fe982389424bf56ca723febf8e8a590de5f7e34d5a5ca7964f7b812f257e3050` 与 OCI revision `f95e08caae0ddf4dfee23912fe87153a8afb8dff`；`v0.1.1`、`v0.1.0` 的发布事实和历史截图也继续保留。公网交互式 Web 后端未部署；发布公开 CLI 镜像不等于部署公网交互式 Web 后端。
