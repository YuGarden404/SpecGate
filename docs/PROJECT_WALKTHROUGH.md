...
7. 最后展示发布链并区分部署边界：PR #30 合并后的 `main@f95e08c` 已由 [CI #73](https://github.com/YuGarden404/SpecGate/actions/runs/30678670251)、[Pages #41](https://github.com/YuGarden404/SpecGate/actions/runs/30678670260) 和 [GHCR #3](https://github.com/YuGarden404/SpecGate/actions/runs/30679259458) 验证；[v0.2.0](https://github.com/YuGarden404/SpecGate/releases/tag/v0.2.0) 已发布，`ghcr.io/yugarden404/specgate:0.2.0` 已完成匿名拉取验证，digest 为 `sha256:fe982389424bf56ca723febf8e8a590de5f7e34d5a5ca7964f7b812f257e3050`，OCI revision 为 `f95e08caae0ddf4dfee23912fe87153a8afb8dff`。`v0.1.1`、`v0.1.0` 的发布事实和历史截图继续保留。公网交互式 Web 后端未部署；发布公开 CLI 镜像不等于部署公网交互式 Web 后端。
