...
- Stage B 证据同步分支验证为 `Ran 955 tests in 404.159s`、`OK (skipped=27)`，退出码 0；新增 1 项来自发布事实契约，不替换教师干净克隆基线。
...
- 当前发布基线为 PR #32 合并后的 `main@e3ec022`：CI #77 / run 30728989649、Pages #43 / run 30728989651 与 GHCR #4 / run 30729409707 均成功。[`v0.3.0`](https://github.com/YuGarden404/SpecGate/releases/tag/v0.3.0) 已发布；`ghcr.io/yugarden404/specgate:0.3.0` 的 digest 为 `sha256:baa5c61bd791f2b5e266e98fbd17affb1e9e6fd6dab6e829279a05d934f021e0`，OCI revision 为 `e3ec02236f6e65ccce2c49ab444ba0676db5a7ed`。匿名 pull、CLI help、Mock Demo、Web help 与 OCI version 检查均退出码 0。NJU GitLab 的当前 `main` 与版本标签仍受外部 TLS/网络问题阻塞，待重试，不能声称双仓库已同步。公网交互式 Web 后端未部署。
- `v0.2.0` 是已验证的历史发布；PR #30、`main@f95e08c`、CI #73 / run 30678670251、Pages #41 / run 30678670260、GHCR #3 / run 30679259458、[Release](https://github.com/YuGarden404/SpecGate/releases/tag/v0.2.0)、镜像 `ghcr.io/yugarden404/specgate:0.2.0`、digest `sha256:fe982389424bf56ca723febf8e8a590de5f7e34d5a5ca7964f7b812f257e3050` 与 OCI revision `f95e08caae0ddf4dfee23912fe87153a8afb8dff` 保持不变。
- `v0.1.1` 是已验证的历史发布；PR #28、`main@9cf9093`、CI #69 / run 29678498485、Pages #39 / run 29678498457、GHCR #2 / run 29679264248、NJU Pipeline #313118 / job #596642 保持不变。Annotated tag object 为 `adb74ca0586b20e3cb5e32767bb409370e70c2ef`，peeled commit 与 OCI revision 为 `9cf909341cd1a5feb8ed2b244ce31f0495016c4c`；`ghcr.io/yugarden404/specgate:0.1.1` 的 digest 为 `sha256:8cb8e5b9c9483a7f6bb70cc27fc3f3053b48be2f4a69374865e7bcbbaca4fd0f`，证据为 `docs/evidence/github-actions-ghcr-v0.1.1-success.png`、`docs/evidence/github-package-specgate-v0.1.1-public.png`、`docs/evidence/ghcr-v0.1.1-anonymous-smoke.png`。
- `v0.1.0` 是已验证的历史公开镜像；`main@44b236f`、PR #25、[CI #63](https://github.com/YuGarden404/SpecGate/actions/runs/29649068245)、[Pages #36](https://github.com/YuGarden404/SpecGate/actions/runs/29649068246)、[GHCR #1](https://github.com/YuGarden404/SpecGate/actions/runs/29649149933)、digest `sha256:324fad1d8ae82880990a3e032847408b9339bf52bd81dc53b61e74dcb4b6ea3d` 与 `docs/evidence/github-actions-pr25-ci-success.png`、`docs/evidence/github-actions-pr25-pages-success.png`、`docs/evidence/github-actions-ghcr-v0.1.0-success.png`、`docs/evidence/github-package-specgate-public.png`、`docs/evidence/ghcr-anonymous-pull-smoke.png` 原样保留。
...
- 双仓库边界：SpecGate 是 CLI-first Harness；GitHub 开发主仓库保存 PR/Actions、Docker 构建与 Pages 历史，[NJU GitLab 课程镜像](https://git.nju.edu.cn/YuyuanLiang/specgate) 已公开。Pipeline #312781、#312784、#312797 的三次 `unit-test` 已通过；容器构建分别受 DinD privileged、`gcr.io` 超时和 RootlessKit `operation not permitted` 限制。GitLab CI 随后只保留 `unit-test`；历史 Pipeline #312806、教师源码基线 Pipeline #313088 / job #596503 与 `v0.1.1` 的 Pipeline #313118 / job #596642 均已通过。`v0.2.0` 尚待 TLS/网络恢复后同步。
- 部署边界：GHCR 公开镜像已完成匿名拉取验证，公开容器 registry 已完成。公网交互式 Web 后端未部署；发布公开 CLI 镜像不等于部署公网交互式 Web 后端，发布镜像不等于部署服务。
