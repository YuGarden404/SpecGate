...
- 当前发布基线为 PR #30 合并后的 `main@f95e08c`：CI #73 / run 30678670251、Pages #41 / run 30678670260 与 GHCR #3 / run 30679259458 均成功。[`v0.2.0`](https://github.com/YuGarden404/SpecGate/releases/tag/v0.2.0) 已发布；`ghcr.io/yugarden404/specgate:0.2.0` 的 digest 为 `sha256:fe982389424bf56ca723febf8e8a590de5f7e34d5a5ca7964f7b812f257e3050`，OCI revision 为 `f95e08caae0ddf4dfee23912fe87153a8afb8dff`。匿名 pull、CLI help、Mock Demo、Web help 均退出码 0。NJU GitLab 的 `v0.2.0` 同步因外部 TLS/网络错误尚未完成，不能声称双仓库已同步。
